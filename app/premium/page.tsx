      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Get access to AI-powered cooking tools, unlimited recipes, and personalized meal
            planning with MealMuse Premium
          </p>
        </div>
          ...
          >
            ...
            <CardContent className="space-y-4">
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <span style={{ color: "#1FA244" }}>✓</span>
                  <span>🔄 Recipe Rewriter & Adapter</span>
                </li>
                <li className="flex items-start gap-2">
                  <span style={{ color: "#1FA244" }}>✓</span>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Our AI analyzes your available ingredients, dietary preferences, and cooking
                  skills to generate personalized recipes. It uses state-of-the-art language models
                  to create unique, practical recipes.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="mt-16 text-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
                Join thousands of home chefs using AI to discover new recipes, plan meals, and
              ...
              >
                Start Your Premium Journey - $9.99/mo
              </Button>
