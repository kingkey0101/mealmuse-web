...
export function PremiumPageClient() {
  ...
  useEffect(() => {
    getEarlyAdopterStatus().then(setEarlyAdopterStatus);
  }, []);
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16 max-w-6xl mx-auto">
        ...
        <Card
          ...
          style={{
            ...
            backgroundColor: earlyAdopterStatus?.isEligible ? "rgba(232, 166, 40, 0.02)" : "rgba(13, 95, 58, 0.02)",
          }}
        >
      ...
      {earlyAdopterStatus?.isEligible === false && !isPremium && (
        <div className="mb-16 max-w-2xl mx-auto">
          <Card className="border-2 p-6" style={{ borderColor: "#FF6B35", backgroundColor: "rgba(255, 107, 53, 0.05)" }}>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                $6.99/month - that's 30% off regular pricing and it never increases. This is our
                way of saying thank you for believing in MealMuse early!
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                We don&apos;t offer a free trial, but you can start with our generous free plan
                and upgrade when you&apos;re ready. Early adopters get an extra 30% discount!
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {earlyAdopterStatus?.isEligible && (
                ...
                >
                  {loadingEarlyAdopter ? "Loading..." : "🔥 Claim $6.99/mo - {" "}
                  {earlyAdopterStatus.slotsRemaining} Left"}
                </Button>
              )}
              <Button
                onClick={() => handleCheckout("annual")}
