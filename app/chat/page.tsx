    ...
    <DashboardLayout>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <Card
          ...
          style={{ borderColor: "#E8A628", backgroundColor: "rgba(232, 166, 40, 0.05)" }}
        >
          <div className="mx-auto max-w-2xl space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                We&apos;re cooking up something special! Our AI chef will soon be able to answer
                your cooking questions, suggest recipe modifications, help with ingredient
                substitutions, and provide personalized culinary guidance.
              </p>
            </div>
            <div className="pt-4">
              <div
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            },
            {
              ...
              description:
                "Ask about substitutions, measurements, and how to work with different ingredients",
              icon: (
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
            ...
            },
            {
              ...
              description:
                "Automatically generate organized shopping lists from your selected recipes and ingredients",
              icon: (
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
            ...
            },
            {
              ...
              description:
                "Learn proper cooking methods, timing, and techniques to improve your skills",
              icon: (
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
