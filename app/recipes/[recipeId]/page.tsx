              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <svg className="h-5 w-5 shrink-0" style={{ color: "#7A8854" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold" style={{ color: "#0D5F3A" }}>{recipe.skill}</p>
                    </div>
                  </div>
                  ...
                  {recipe.cookingTime && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold" style={{ color: "#0D5F3A" }}>{recipe.cookingTime} minutes</p>
                      </div>
                    </div>
                  )}
                  ...
                  {recipe.dietary && recipe.dietary.length > 0 && (
                    <div className="flex items-start gap-3">
                      <svg className="h-5 w-5 shrink-0 mt-0.5" style={{ color: "#7A8854" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <ul className="space-y-2.5">
                  {recipe.ingredients.map((item, i) => (
                    <li key={i} className="flex items-start gap-2.5">
                      <span className="mt-2 flex h-1.5 w-1.5 shrink-0 rounded-full" style={{ backgroundColor: "#7A8854" }} />
                ...
                <ul className="space-y-2.5">
                  {recipe.equipment.map((tool, i) => (
                    <li key={i} className="flex items-center gap-2.5">
                      <span className="flex h-1.5 w-1.5 shrink-0 rounded-full" style={{ backgroundColor: "#1FA244" }} />
          ...
          <div className="lg:col-span-2">
            <Card className="shadow-lg h-full" style={{ backgroundColor: "#E5D1DA" }}>
              ...
              <CardContent className="pt-8">
                <h2 className="text-2xl font-bold mb-6" style={{ color: "#0D5F3A" }}>Instructions</h2>
